...
export function wireContent() {
  ...
  if (prose) prose.innerHTML = `
    ...
    <figure class="article-scene">
      <img src="/assets/spots/c2-pig.png" alt="Domestic pig side-profile, paper-cut spot illustration" width="1024" height="1024" loading="lazy">
    </figure>
    ...
    <figure class="article-scene">
      <img src="/assets/spots/c3-hen.png" alt="Domestic hen side-profile, paper-cut spot illustration" width="1024" height="1024" loading="lazy">
    </figure>
