...
export function wireContent() {
  ...
  if (prose) prose.innerHTML = `
    <p>The figure of 60 kilograms of CO₂ equivalent per kilogram of beef comes from the most comprehensive life-cycle analysis of food systems yet published. Joseph Poore and Thomas Nemecek's 2018 paper in <em>Science</em>, "Reducing food's environmental impacts through producers and consumers," synthesized data from 38,700 farms in 119 countries and 40 food products. The range of emissions outcomes across beef producers, from the most efficient grass-fed operations to the least efficient industrial feedlot systems, was enormous, but even the bottom tenth percentile of beef producers still generated more emissions per unit of protein than the top tenth percentile of almost any plant-based food.</p>

    <figure class="article-scene">
      <img src="/assets/scenes/a3-rolling-hills.png" alt="Rolling pastoral hills with fence, paper-cut illustration" width="1536" height="1024" loading="lazy">
    </figure>
    ...
    <figure class="article-scene">
      <img src="/assets/spots/c4-steer-head.png" alt="Steer head close-up, paper-cut spot illustration" width="1024" height="1024" loading="lazy">
    </figure>
    ...
    <figure class="article-scene">
      <img src="/assets/spots/d2-species-grid.png" alt="Four-species carbon comparison grid (hen, pig, fish, plant), paper-cut illustration" width="1024" height="1024" loading="lazy">
    </figure>
    ...
    <p>The IPCC's Sixth Assessment Report, specifically its chapter on agriculture, forestry, and other land use (AFOLU), notes that demand-side changes (dietary shifts in high-income countries) are among the mitigation options with the largest potential, but that realizing that potential requires policy support, not merely individual persuasion. The IPCC also identifies methane reduction as a near-term climate priority, and livestock agriculture is the single largest anthropogenic source of methane globally. Almost no voluntary corporate climate commitments in the meat industry include any binding, verified commitment to reduce absolute emissions (as opposed to emissions intensity per unit of production) over a defined timeline. The distinction matters because an industry that produces more beef more efficiently can increase its absolute emissions while decreasing its per-unit figure. The atmosphere responds to absolute quantities.</p>
